...
class softsplat_func(torch.autograd.Function):
    ...
    def forward(self, tenIn, tenFlow):
        ...
        if tenIn.is_cuda == True:
            kernel_function = cuda_launch(cuda_kernel('softsplat_out', '''
    ...
    def backward(self, tenOutgrad):
        ...
        if tenIngrad is not None:
            kernel_function = cuda_launch(cuda_kernel('softsplat_ingrad', '''
        ...
        if tenFlowgrad is not None:
            kernel_function = cuda_launch(cuda_kernel('softsplat_flowgrad', '''
